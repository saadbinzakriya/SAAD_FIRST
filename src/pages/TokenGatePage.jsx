...
export default function TokenGatePage() {
  ...
  useEffect(() => { setThemeKey(getSystemTheme()); }, []);
  ...
  return (
    <div className={`mecha-root ${cursorEnabled ? 'no-native-cursor' : ''}`} style={{ minHeight: '100vh', ...themeVars(theme) }}>
      <GlobalStyle />
